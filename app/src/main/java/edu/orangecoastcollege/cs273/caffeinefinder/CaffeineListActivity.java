...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Instruct Android to load a Google Map into the fragment(caffeineMapFragment)
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap; // Store reference to Google Map in member variable
        // Custom marker (Big Blue one - my_marker.png)
        LatLng myPosition = new LatLng(33.671028, -117.9111305);
        ...
        // Move the map to cameraUpdate
        mMap.moveCamera(cameraUpdate);

        // Plot each location from the list with a standard marker
